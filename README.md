...
- **Currency**: Toman
- [Download Latest Persian Version](https://github.com/your-username/financial-manager/releases/latest?q=persian&expanded=true)

## 📥 Installation

### Windows Executable (Recommended)
Download the appropriate `.exe` file from the [Releases](https://github.com/your-username/financial-manager/releases) page.
